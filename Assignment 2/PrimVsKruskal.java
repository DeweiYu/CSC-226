/* PrimVsKruskal.java
 CSC 226 - Summer 2022
 Assignment 2 Programming Component - Prim MST versus Kruskal MST Template
 ...
 java PrimVsKruskal examplegraph.txt
	
 where examplegraph.txt can be replaced by the name of any graph text file.
...
public class PrimVsKruskal {
    ...
    public static void main(String[] args) {
        // args = new String[] {"examplegraph.txt", "ewg_100vertices_9.txt", "ewg_50vertices_9.txt", "ewg_10vertices_0.txt",};
        Scanner s;
        if (args.length > 0) {
            try {
